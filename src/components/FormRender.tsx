      ...
      <FormControl>
        <div className="relative">
          <input
            ...
            className="bg-transparent border-black border-[1px] text-black rounded-lg h-10 px-4 w-full focus:outline-none focus:ring-2 focus:ring-[--prodile-yellow] focus:border-[--prodile-yellow] placeholder:text-[#646464]"
          />
